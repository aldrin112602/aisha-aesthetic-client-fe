...
function EmployeeManagement() {
  ...
  const handleEditEmployee = async (
    ...
    /*
     * Keep the employee's existing area.
     *
     * If that area still exists in the
     * admin-created shop areas, it will
     * appear normally in the dropdown.
     */
                  ...
                  (employee) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        ...
                        <span
                          className={`rounded-full px-2.5 py-1 text-xs font-semibold uppercase ${getStatusColor(
                            employee.status
                          )}`}
                        >
                          {employee.status}
