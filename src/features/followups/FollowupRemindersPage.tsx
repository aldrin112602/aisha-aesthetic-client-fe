  ...
  const handleScheduleFollowup = async (
    ...
    if (!currentUser?.id) {
      await Swal.fire({
        ...
        text: 'Please sign in before scheduling a follow-up.',
    ...
    try {
      ...
      await Swal.fire({
        ...
        text: 'Your follow-up has been scheduled successfully.',
        confirmButtonColor: '#d77a94',
      });
    } catch (error) {
      const message =
      ...
      await Swal.fire({
        ...
        text: `Failed to schedule follow-up: ${message}`,
        confirmButtonColor: '#d77a94',
      });
    } finally {
      setLoading(false);
  ...
  const updateStatus = async (
    ...
    try {
      ...
      await Swal.fire({
        ...
        text: 'The follow-up has been marked as completed.',
        confirmButtonColor: '#d77a94',
      });
    } catch (error) {
      const message =
      ...
      await Swal.fire({
        icon: 'error',
        title: 'Update Failed',
        text: `Failed to update follow-up: ${message}`,
        confirmButtonColor: '#d77a94',
      });
    }
  };
    ...
    <div className="min-w-0 bg-[#fff8fa] p-4 md:p-6 lg:p-8">
      ...
      <div className="mb-6 flex items-center gap-2 rounded-xl border border-green-200 bg-green-50 px-4 py-3">
        ...
        <p className="text-sm font-semibold text-green-800">
          📧 Email notifications enabled. All reminders will be sent to
      ...
      <div className="mb-6 flex items-center justify-between gap-3">
        <div>
          ...
          <p className="page-subtitle">
            Manage appointment reminders and service follow-ups.
          </p>
        </div>
        ...
        <div className="mb-6 rounded-2xl border border-pink-100 bg-white p-6 shadow-sm">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="primary-btn mt-4 disabled:opacity-70"
            >
              {loading
                ? 'Scheduling...'
                : 'Schedule Follow-up'}
