function AdminDashboard() {
  return (
    <div className="page-container">
      ...
      <p className="page-subtitle">Overview of appointments, staff, services, and system activity.</p>
      ...
      <div className="mt-8 grid gap-5 xl:grid-cols-2">
        ...
        <div className="pink-card">
          <h2 className="text-lg font-bold text-[#4b343b]">Employee Duty Status</h2>
          <ul className="mt-4 space-y-3 text-sm text-[#6d4a54]">
            <li>On Duty: 7</li>
            <li>Available: 4</li>
            <li>On Break: 2</li>
